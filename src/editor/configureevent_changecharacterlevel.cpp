...
ConfigureEvent_ChangeCharacterLevel::ConfigureEvent_ChangeCharacterLevel(QWidget *parent) : QDialog(parent)
{
	setupUi(this);
...
ConfigureEvent_ChangeCharacterLevel::~ConfigureEvent_ChangeCharacterLevel()
{
}

void ConfigureEvent_ChangeCharacterLevel::setTarget(int target)
{
...
void ConfigureEvent_ChangeCharacterLevel::setCharacterID(int characterID)
{
...
void ConfigureEvent_ChangeCharacterLevel::setOperation(bool add)
{
	if (add)
		rbAddLevels->setChecked(true);
	else
		rbRemoveLevels->setChecked(true);
}

void ConfigureEvent_ChangeCharacterLevel::setAmount(int amount)
{
...
void ConfigureEvent_ChangeCharacterLevel::setIsStoredAmount(bool storedAmount)
{
	if (storedAmount)
...
void ConfigureEvent_ChangeCharacterLevel::setShowLevelUpMessage(bool showMessage)
{
	cbShowLevelUpMessage->setChecked(showMessage);
}

int ConfigureEvent_ChangeCharacterLevel::getTarget()
{
...
int ConfigureEvent_ChangeCharacterLevel::getCharacterID()
{
	if (rbSpecificCharacter->isChecked())
...
bool ConfigureEvent_ChangeCharacterLevel::isAddOperation()
{
	return rbAddLevels->isChecked();
}

int ConfigureEvent_ChangeCharacterLevel::getAmount()
{
	if (rbSpecificAmount->isChecked())
...
bool ConfigureEvent_ChangeCharacterLevel::isStoredAmount()
{
	return rbStoredAmount->isChecked();
}

bool ConfigureEvent_ChangeCharacterLevel::showLevelUpMessage()
{
	return cbShowLevelUpMessage->isChecked();
}

void ConfigureEvent_ChangeCharacterLevel::on_bBrowseAmountVariables_clicked()
{
...
void ConfigureEvent_ChangeCharacterLevel::on_bBrowseCharacterVariables_clicked()
{
	VariableSelector *variableSelector;
...
void ConfigureEvent_ChangeCharacterLevel::on_rbAddLevels_toggled(bool checked)
{
	frmOption->setEnabled(checked);
}

void ConfigureEvent_ChangeCharacterLevel::on_rbReferencedCharacter_toggled(bool checked)
{
	wCharacterVariable->setEnabled(checked);
}

void ConfigureEvent_ChangeCharacterLevel::on_rbSpecificAmount_toggled(bool checked)
{
	wAmount->setEnabled(checked);
	wAmountVariable->setEnabled(!checked);
}

void ConfigureEvent_ChangeCharacterLevel::on_rbSpecificCharacter_toggled(bool checked)
{
