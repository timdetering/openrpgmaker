...
#ifndef CONFIGUREEVENT_CHANGECHARACTERHP_H
#define CONFIGUREEVENT_CHANGECHARACTERHP_H

#include "ui_configureevent_changecharacterhp.h"

class ConfigureEvent_ChangeCharacterHP : public QDialog, public Ui::ConfigureEvent_ChangeCharacterHP
{
	Q_OBJECT
	public:
		enum Target {ENTIRE_PARTY=0, SPECIFIC_CHARACTER, REFERENCED_CHARACTER};
		ConfigureEvent_ChangeCharacterHP(QWidget *parent=0);
		~ConfigureEvent_ChangeCharacterHP();
...
#endif // CONFIGUREEVENT_CHANGECHARACTERHP_H
