...
#ifndef PROJECTDATA_TITLEMENULAYOUT_H
#define PROJECTDATA_TITLEMENULAYOUT_H
...
class TitleMenuLayout
{
	public:
		...
		TitleMenuLayout();
		TitleMenuLayout(XMLNode MenuNode);
		TitleMenuLayout(StorageFile &storageFile);
		~TitleMenuLayout();
...
#endif // PROJECTDATA_TITLEMENULAYOUT_H
