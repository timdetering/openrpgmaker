...
#ifndef CONFIGUREEVENT_MAPCONDITIONALBRANCH_CONFIGURECONDITION_H
#define CONFIGUREEVENT_MAPCONDITIONALBRANCH_CONFIGURECONDITION_H

#include "ui_configureevent_mapconditionalbranch_configurecondition.h"
#include "projectdata_baseevent.h"

class ConfigureEvent_MapConditionalBranch_ConfigureCondition : public QDialog, public Ui::ConfigureEvent_MapConditionalBranch_ConfigureCondition
{
	Q_OBJECT
	public:
		...
		enum SpriteConditionType {SPRITE_HERO, SPRITE_VEHICLE, SPRITE_EVENT};
		ConfigureEvent_MapConditionalBranch_ConfigureCondition(int mapID, QWidget *parent=0);
		~ConfigureEvent_MapConditionalBranch_ConfigureCondition();
		void setCondition(BaseEvent::ConditionalBranch_Map::Condition *condition);
		void getCondition(BaseEvent::ConditionalBranch_Map::Condition *condition);
	protected slots:
		...
		void on_rbEventStartedWithActionKey_toggled(bool checked);
		...
		void on_rbSprite_toggled(bool checked);
		...
		void on_sprite_bBrowseEventVariables_clicked();
		void on_sprite_bBrowseVehicleVariables_clicked();
		void on_sprite_cboxType_currentIndexChanged(int index);
		void on_sprite_rbSpecificEvent_toggled(bool checked);
		void on_sprite_rbSpecificVehicle_toggled(bool checked);
	...
	private:
		...
		static QList<int> sprite_directionIDs;
};

#endif // CONFIGUREEVENT_MAPCONDITIONALBRANCH_CONFIGURECONDITION_H
