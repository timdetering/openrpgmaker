...
#ifndef CONFIGUREEVENT_MOVEEVENT_H
#define CONFIGUREEVENT_MOVEEVENT_H

#include "ui_configureevent_moveevent.h"
#include "projectdata_mapevent.h"

class ConfigureEvent_MoveEvent : public QDialog, public Ui::ConfigureEvent_MoveEvent
{
	Q_OBJECT
	public:
		enum EventType {HERO=0, THIS_EVENT, VEHICLE, EVENT};
		ConfigureEvent_MoveEvent(int mapID, QWidget *parent=0);
		~ConfigureEvent_MoveEvent();
		int getEventID();
...
#endif // CONFIGUREEVENT_MOVEEVENT_H
