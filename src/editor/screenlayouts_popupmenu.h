...
#ifndef SCREENLAYOUTS_POPUPMENU_H
#define SCREENLAYOUTS_POPUPMENU_H

#include "ui_screenlayouts_popupmenu.h"
#include "projectdata.h"

class ScreenLayouts_PopupMenu : public QWidget, public Ui::ScreenLayouts_PopupMenu
{
	Q_OBJECT
	public:
		...
		ScreenLayouts_PopupMenu(QWidget *parent=0);
		~ScreenLayouts_PopupMenu();
		void setupLayout();
		void shutdownLayout();
	...
	protected slots:
		...
		void on_gvPopupMenuLayout_customContextMenuRequested(const QPoint &pos);
		void on_gvPopupMenuLayout_dragEnterEvent(QDragEnterEvent *event);
		void on_gvPopupMenuLayout_dragLeaveEvent(QDragLeaveEvent *event);
		void on_gvPopupMenuLayout_dragMoveEvent(QDragMoveEvent *event);
		void on_gvPopupMenuLayout_dropEvent(QDropEvent *event);
		void on_gvPopupMenuLayout_leaveEvent(QEvent *event);
		void on_gvPopupMenuLayout_mouseDoubleClickEvent(QMouseEvent *event);
		void on_gvPopupMenuLayout_mouseMoveEvent(QMouseEvent *event);
		void on_gvPopupMenuLayout_mousePressEvent(QMouseEvent *event);
		void on_gvPopupMenuLayout_mouseReleaseEvent(QMouseEvent *event);
	...
	private:
		...
		ProjectData::DataReference<PopupMenuLayout> *layoutRef;
...
#endif // SCREENLAYOUTS_POPUPMENU_H
