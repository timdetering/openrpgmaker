...
ConfigureMapEventPrecondition::ConfigureMapEventPrecondition(QWidget *parent) : QDialog(parent)
{
...
ConfigureMapEventPrecondition::~ConfigureMapEventPrecondition()
{
}

void ConfigureMapEventPrecondition::setCondition(MapEvent::Precondition *condition)
{
	int conditionType = condition->getType();
	if (conditionType == MapEvent::Precondition::SWITCH)
	{
		MapEvent::SwitchCondition switchCondition;
	...
	else if (conditionType == MapEvent::Precondition::VARIABLE)
	{
		MapEvent::VariableCondition variableCondition;
	...
	else if (conditionType == MapEvent::Precondition::STRING)
	{
		MapEvent::StringCondition stringCondition;
		...
		if (stringCondition.dstStringType == MapEvent::StringCondition::STRING_VARIABLE)
		{
		...
		else if (stringCondition.dstStringType == MapEvent::StringCondition::REFERENCED_STRING)
		{
	...
	else if (conditionType == MapEvent::Precondition::TIMER)
	{
		MapEvent::TimerCondition timerCondition;
	...
	else if (conditionType == MapEvent::Precondition::MONEY)
	{
		MapEvent::MoneyCondition moneyCondition;
	...
	else if (conditionType == MapEvent::Precondition::ITEM)
	{
		MapEvent::ItemCondition itemCondition;
	...
	else if (conditionType == MapEvent::Precondition::HERO)
	{
		MapEvent::HeroCondition heroCondition;
	...
	else if (conditionType == MapEvent::Precondition::PARTY_IS_RIDING)
	{
		MapEvent::PartyIsRidingCondition partyIsRidingCondition;
...
void ConfigureMapEventPrecondition::getCondition(MapEvent::Precondition *condition)
{
	if (rbSwitch->isChecked())
	{
		MapEvent::SwitchCondition switchCondition;
		condition->setType(MapEvent::Precondition::SWITCH);
	...
	{
		MapEvent::VariableCondition variableCondition;
		condition->setType(MapEvent::Precondition::VARIABLE);
	...
	{
		MapEvent::StringCondition stringCondition;
		condition->setType(MapEvent::Precondition::STRING);
	...
	{
		MapEvent::TimerCondition timerCondition;
		condition->setType(MapEvent::Precondition::TIMER);
	...
	{
		MapEvent::MoneyCondition moneyCondition;
		condition->setType(MapEvent::Precondition::MONEY);
	...
	{
		MapEvent::ItemCondition itemCondition;
		condition->setType(MapEvent::Precondition::ITEM);
	...
	else if (rbHero->isChecked())
	{
		...
		condition->setType(MapEvent::Precondition::HERO);
	...
	{
		MapEvent::PartyIsRidingCondition partyIsRidingCondition;
		condition->setType(MapEvent::Precondition::PARTY_IS_RIDING);
...
void ConfigureMapEventPrecondition::on_item_bBrowseVariables_clicked()
{
...
void ConfigureMapEventPrecondition::on_item_rbSpecificItem_toggled(bool checked)
{
	item_cboxItems->setEnabled(checked);
	item_wVariable->setEnabled(!checked);
}

void ConfigureMapEventPrecondition::on_money_bBrowseVariables_clicked()
{
	VariableSelector *variableSelector;
...
void ConfigureMapEventPrecondition::on_money_rbSpecificValue_toggled(bool checked)
{
	money_wValue->setEnabled(checked);
	money_wVariable->setEnabled(!checked);
}

void ConfigureMapEventPrecondition::on_rbHero_toggled(bool checked)
{
	if (checked)
		stackedWidget->setCurrentWidget(wHero);
}

void ConfigureMapEventPrecondition::on_rbItem_toggled(bool checked)
{
	if (checked)
		stackedWidget->setCurrentWidget(wItem);
}

void ConfigureMapEventPrecondition::on_rbMoney_toggled(bool checked)
{
	if (checked)
		stackedWidget->setCurrentWidget(wMoney);
}

void ConfigureMapEventPrecondition::on_rbPartyIsRiding_toggled(bool checked)
{
	if (checked)
		stackedWidget->setCurrentWidget(wPartyIsRiding);
}

void ConfigureMapEventPrecondition::on_rbString_toggled(bool checked)
{
	if (checked)
		stackedWidget->setCurrentWidget(wString);
}

void ConfigureMapEventPrecondition::on_rbSwitch_toggled(bool checked)
{
	if (checked)
		stackedWidget->setCurrentWidget(wSwitch);
}

void ConfigureMapEventPrecondition::on_rbTimer_toggled(bool checked)
{
	if (checked)
		stackedWidget->setCurrentWidget(wTimer);
}

void ConfigureMapEventPrecondition::on_rbVariable_toggled(bool checked)
{
	if (checked)
		stackedWidget->setCurrentWidget(wVariable);
}

void ConfigureMapEventPrecondition::on_riding_bBrowseVariables_clicked()
{
	VariableSelector *variableSelector;
...
void ConfigureMapEventPrecondition::on_riding_rbSpecificVehicle_toggled(bool checked)
{
	riding_cboxVehicles->setEnabled(checked);
	riding_wVariable->setEnabled(!checked);
}

void ConfigureMapEventPrecondition::on_string_bBrowseReferenceVariables_clicked()
{
	VariableSelector *variableSelector;
...
void ConfigureMapEventPrecondition::on_string_bBrowseStrings_clicked()
{
	VariableSelector *variableSelector;
...
void ConfigureMapEventPrecondition::on_string_bBrowseValueStrings_clicked()
{
	VariableSelector *variableSelector;
...
void ConfigureMapEventPrecondition::on_string_bBrowseVariables_clicked()
{
	VariableSelector *variableSelector;
...
void ConfigureMapEventPrecondition::on_string_rbSpecificString_toggled(bool checked)
{
	string_wString->setEnabled(checked);
	string_wVariable->setEnabled(!checked);
}

void ConfigureMapEventPrecondition::on_string_rbSpecificValue_toggled(bool checked)
{
	string_leValue->setEnabled(checked);
}

void ConfigureMapEventPrecondition::on_string_rbValueInReferencedString_toggled(bool checked)
{
	string_wReferencedString->setEnabled(checked);
}

void ConfigureMapEventPrecondition::on_string_rbValueInString_toggled(bool checked)
{
	string_wValueString->setEnabled(checked);
}

void ConfigureMapEventPrecondition::on_switch_bBrowseSwitches_clicked()
{
	VariableSelector *variableSelector;
...
void ConfigureMapEventPrecondition::on_switch_bBrowseVariables_clicked()
{
	VariableSelector *variableSelector;
...
void ConfigureMapEventPrecondition::on_switch_rbSpecificSwitch_toggled(bool checked)
{
	switch_wSwitch->setEnabled(checked);
	switch_wVariable->setEnabled(!checked);
}

void ConfigureMapEventPrecondition::on_timer_bBrowseTimeVariables_clicked()
{
	VariableSelector *variableSelector;
...
void ConfigureMapEventPrecondition::on_timer_bBrowseTimerVariables_clicked()
{
	VariableSelector *variableSelector;
...
void ConfigureMapEventPrecondition::on_timer_rbSpecificTime_toggled(bool checked)
{
	timer_wTime->setEnabled(checked);
	timer_wTimeVariable->setEnabled(!checked);
}

void ConfigureMapEventPrecondition::on_timer_rbSpecificTimer_toggled(bool checked)
{
	timer_wTimer->setEnabled(checked);
	timer_wTimerVariable->setEnabled(!checked);
}

void ConfigureMapEventPrecondition::on_variable_bBrowseValueVariables_clicked()
{
	VariableSelector *variableSelector;
...
void ConfigureMapEventPrecondition::on_variable_bBrowseVariables_clicked()
{
	VariableSelector *variableSelector;
...
void ConfigureMapEventPrecondition::on_variable_rbSpecificValue_toggled(bool checked)
{
	variable_wValue->setEnabled(checked);
	variable_wValueVariable->setEnabled(!checked);
}

void ConfigureMapEventPrecondition::on_hero_rbSpecificCharacter_toggled(bool checked)
{
	hero_cboxCharacters->setEnabled(checked);
	hero_wVariable->setEnabled(!checked);
}

void ConfigureMapEventPrecondition::on_hero_bBrowseVariables_clicked()
{
	VariableSelector *variableSelector;
...
void ConfigureMapEventPrecondition::on_hero_cboxCondition_currentIndexChanged(int index)
{
...
void ConfigureMapEventPrecondition::on_heroname_rbSpecificValue_toggled(bool checked)
{
	heroname_leValue->setEnabled(checked);
}

void ConfigureMapEventPrecondition::on_heroname_rbValueInString_toggled(bool checked)
{
	heroname_wStrings->setEnabled(checked);
}

void ConfigureMapEventPrecondition::on_heroname_rbValueInReferencedString_toggled(bool checked)
{
	heroname_wVariable->setEnabled(checked);
}

void ConfigureMapEventPrecondition::on_heroname_bBrowseStrings_clicked()
{
	VariableSelector *variableSelector;
...
void ConfigureMapEventPrecondition::on_heroname_bBrowseVariables_clicked()
{
	VariableSelector *variableSelector;
...
void ConfigureMapEventPrecondition::on_herolevel_rbSpecificValue_toggled(bool checked)
{
	herolevel_wValue->setEnabled(checked);
	herolevel_wVariable->setEnabled(!checked);
}

void ConfigureMapEventPrecondition::on_herolevel_bBrowseVariables_clicked()
{
	VariableSelector *variableSelector;
...
void ConfigureMapEventPrecondition::on_herohp_rbSpecificValue_toggled(bool checked)
{
	herohp_wValue->setEnabled(checked);
	herohp_wVariable->setEnabled(!checked);
}

void ConfigureMapEventPrecondition::on_herohp_bBrowseVariables_clicked()
{
	VariableSelector *variableSelector;
...
void ConfigureMapEventPrecondition::on_heroskill_rbSpecificSkill_toggled(bool checked)
{
	heroskill_cboxSkills->setEnabled(checked);
	heroskill_wVariable->setEnabled(!checked);
}

void ConfigureMapEventPrecondition::on_heroskill_bBrowseVariables_clicked()
{
	VariableSelector *variableSelector;
...
void ConfigureMapEventPrecondition::on_heroitem_rbSpecificItem_toggled(bool checked)
{
	heroitem_cboxItems->setEnabled(checked);
	heroitem_wVariable->setEnabled(!checked);
}

void ConfigureMapEventPrecondition::on_heroitem_bBrowseVariables_clicked()
{
	VariableSelector *variableSelector;
...
void ConfigureMapEventPrecondition::on_herocondition_rbSpecificCondition_toggled(bool checked)
{
	herocondition_cboxConditions->setEnabled(checked);
	herocondition_wVariable->setEnabled(!checked);
}

void ConfigureMapEventPrecondition::on_herocondition_bBrowseVariables_clicked()
{
	VariableSelector *variableSelector;
...
QStringList ConfigureMapEventPrecondition::getEquipItems()
{
