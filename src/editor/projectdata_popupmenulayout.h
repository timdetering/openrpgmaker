...
#ifndef PROJECTDATA_POPUPMENULAYOUT_H
#define PROJECTDATA_POPUPMENULAYOUT_H
...
class PopupMenuLayout
{
	public:
		...
		PopupMenuLayout();
		PopupMenuLayout(XMLNode MenuNode);
		PopupMenuLayout(StorageFile &storageFile);
		~PopupMenuLayout();
...
#endif // PROJECTDATA_POPUPMENULAYOUT_H
