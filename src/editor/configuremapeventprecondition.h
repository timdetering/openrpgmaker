...
#ifndef CONFIGUREMAPEVENTPRECONDITION_H
#define CONFIGUREMAPEVENTPRECONDITION_H

#include "ui_configuremapeventprecondition.h"
#include "projectdata_mapevent.h"

class ConfigureMapEventPrecondition : public QDialog, public Ui::ConfigureMapEventPrecondition
{
	Q_OBJECT
	public:
		...
		ConfigureMapEventPrecondition(QWidget *parent=0);
		~ConfigureMapEventPrecondition();
		void setCondition(MapEvent::Precondition *condition);
		void getCondition(MapEvent::Precondition *condition);
	protected slots:
...
#endif // CONFIGUREMAPEVENTPRECONDITION_H
