...
PopupMenuLayout::PopupMenuLayout(XMLNode MenuNode)
{
	...
	if (MenuNode.nChildNode("navigation") == 1)
		...
		navigation = new MenuNavigation();
	width = QString(MenuNode.getAttribute("width")).toInt();
	height = QString(MenuNode.getAttribute("height")).toInt();
...
PopupMenuLayout::PopupMenuLayout(StorageFile &storageFile)
{
	int numObjects;
	char *temp_string;
...
void PopupMenuLayout::saveToStorageFile(StorageFile &storageFile)
{
...
QStringList PopupMenuLayout::getResources()
{
...
XMLNode PopupMenuLayout::getMenuNode()
{
	XMLNode TempNode, MenuNode = XMLNode::createXMLTopNode("popupmenulayout");
	...
	if (TempNode.nChildNode("object") > 0)
		MenuNode.addChild(TempNode);
	MenuNode.addAttribute("width", QString::number(width).toUtf8().data());
	MenuNode.addAttribute("height", QString::number(height).toUtf8().data());
	for (int i = 0; i < topLevelObjects.size(); ++i)
		MenuNode.addChild(topLevelObjects[i]->getObjectNode());
	return MenuNode;
}

MenuObject *PopupMenuLayout::getObjectByName(QString name)
{
...
MenuObject *PopupMenuLayout::getTopLevelObject(int objectID)
{
	return topLevelObjects[objectID];
}

void PopupMenuLayout::changeObjectName(QString oldName, QString newName)
{
...
void PopupMenuLayout::addTopLevelObject(MenuObject *object)
{
	addObject(object);
...
void PopupMenuLayout::addObject(MenuObject *object)
{
...
void PopupMenuLayout::deleteTopLevelObject(MenuObject *object)
{
	int objectID = -1;
...
int PopupMenuLayout::numTopLevelObjects()
{
	return topLevelObjects.size();
}

int PopupMenuLayout::numObjectsByType(int type)
{
...
QList<MenuObject*> PopupMenuLayout::getObjectsByType(int type)
{
	QMap<QString, MenuObject*>::iterator objectIter;
...
QList<MenuObject*> PopupMenuLayout::getTopLevelObjectsByType(int type)
{
	QList<MenuObject*> objects;
	for (int i = 0; i < topLevelObjects.size(); ++i)
	{
...
QList<MenuObject*> PopupMenuLayout::getTopLevelObjects()
{
	return topLevelObjects;
}

QStringList PopupMenuLayout::getObjectNamesByType(int type)
{
	QMap<QString, MenuObject*>::iterator objectIter;
...
QStringList PopupMenuLayout::getTopLevelObjectNamesByType(int type)
{
	QStringList objectNames;
	for (int i = 0; i < topLevelObjects.size(); ++i)
	{
...
QStringList PopupMenuLayout::getTopLevelObjectNames()
{
	QStringList objectNames;
	for (int i = 0; i < topLevelObjects.size(); ++i)
		objectNames.append(topLevelObjects[i]->getName());
...
BaseEvent *PopupMenuLayout::getOnAcceptEvent()
{
	return onAcceptEvent;
}

BaseEvent *PopupMenuLayout::getOnCancelEvent()
{
	return onCancelEvent;
}

BaseEvent *PopupMenuLayout::getOnLoadEvent()
{
	return onLoadEvent;
}

BaseEvent *PopupMenuLayout::getOnLeaveEvent()
{
	return onLeaveEvent;
}

BaseEvent *PopupMenuLayout::getOnUpArrowEvent()
{
	return onUpArrowEvent;
}

BaseEvent *PopupMenuLayout::getOnDownArrowEvent()
{
	return onDownArrowEvent;
}

BaseEvent *PopupMenuLayout::getOnLeftArrowEvent()
{
	return onLeftArrowEvent;
}

BaseEvent *PopupMenuLayout::getOnRightArrowEvent()
{
	return onRightArrowEvent;
}

MenuNavigation *PopupMenuLayout::getNavigation()
{
	return navigation;
}

QString PopupMenuLayout::getName()
{
	return menuName;
}

void PopupMenuLayout::setName(QString value)
{
	menuName = value;
}

int PopupMenuLayout::getWidth()
{
	return width;
}

int PopupMenuLayout::getHeight()
{
	return height;
}

void PopupMenuLayout::resize(int newWidth, int newHeight)
{
	width = newWidth;
	height = newHeight;
	if (graphicsScene != NULL)
...
void PopupMenuLayout::setGraphicsScene(QGraphicsScene *value)
{
	graphicsScene = value;
	for (int i = 0; i < topLevelObjects.size(); ++i)
...
void PopupMenuLayout::unsetGraphicsScene()
{
	for (int i = 0; i < topLevelObjects.size(); ++i)
...
void PopupMenuLayout::updateMenuObjects()
{
	QMap<QString, MenuObject*>::iterator objectIter;
	for (objectIter = objectList.begin(); objectIter != objectList.end(); ++objectIter)
	{
...
void PopupMenuLayout::updateZValues()
{
	for (int i = 0; i < topLevelObjects.size(); ++i)
	{
...
void PopupMenuLayout::applyMenuNavigation()
{
...
bool PopupMenuLayout::tryLoad(XMLNode MenuNode)
{
	XMLNode TempNode;
	...
	if (!XMLTools::attributeExists(MenuNode, "width"))
		return false;
	if (!XMLTools::attributeIntRangeValid(MenuNode, "width", 32, 640))
		return false;
	if (!XMLTools::attributeExists(MenuNode, "height"))
		return false;
	if (!XMLTools::attributeIntRangeValid(MenuNode, "height", 32, 480))
		return false;
...
BaseEvent *PopupMenuLayout::createArrowEvent(QString objectName)
{
...
QString PopupMenuLayout::getObjectNameAbovePoint(int row, int column)
{
	QString objectName = "";
	int minRow = navigation->getMinRow();
	int numRows = navigation->getNumRows();
...
QString PopupMenuLayout::getObjectNameBelowPoint(int row, int column)
{
	QString objectName = "";
	int minRow = navigation->getMinRow();
	int numRows = navigation->getNumRows();
...
QString PopupMenuLayout::getObjectNameLeftOfPoint(int row, int column)
{
	QString objectName = "";
	int minColumn = navigation->getMinColumn();
	int numColumns = navigation->getNumColumns();
...
QString PopupMenuLayout::getObjectNameRightOfPoint(int row, int column)
{
	QString objectName = "";
	int minColumn = navigation->getMinColumn();
	int numColumns = navigation->getNumColumns();
...
void PopupMenuLayout::checkObjectList()
{
	QMap<QString, MenuObject*>::iterator objectIter;
	for (objectIter = objectList.begin(); objectIter != objectList.end(); ++objectIter)
	{
